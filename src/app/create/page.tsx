                ...
                <div className="text-center mb-10">
                    ...
                    <div className="mt-3 flex justify-center">
                        <button
                            ...
                            className="text-[11px] font-black text-white bg-gradient-to-r from-pink-500 to-purple-600 px-3 py-1.5 rounded-full border-2 border-black shadow-[2px_2px_0px_black] hover:scale-105 active:scale-95 transition-transform"
                        >
